...
import { type Control, type ControllerRenderProps, type FieldPath, type FieldValues } from 'react-hook-form';
...
interface CustomFieldProps<TFieldValues extends FieldValues, TName extends FieldPath<TFieldValues>> {
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem className='flex-1'>
                    {props.fieldType !== FORM_FIELD.CHECKBOX && props.label && <FormLabel>{props.label}</FormLabel>}
